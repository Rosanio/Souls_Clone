    ...
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        private void HandleRotation(float delta)
        {
            if (inputHandler.lockOnFlag)
            {
                ...
                {
                    Vector3 targetDirection = cameraHandler.transform.forward * inputHandler.vertical;
                    targetDirection += cameraHandler.transform.right * inputHandler.horizontal;
                ...
                {
                    Vector3 rotationDirection = cameraHandler.currentLockOnTarget.lockOnTransform.position - transform.position;
        ...
        public void HandleFalling(float delta, Vector3 moveDirection)
        {
            ...
            if (playerManager.isInAir)
            {
                ...
                rigidbody.AddForce(moveDirection * fallingSpeed / 10f * Mathf.Clamp(2-inAirTimer, 0, 2));
            }
